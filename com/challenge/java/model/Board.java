...
public class Board {
	...
	public void printBoard(){
		...
		for(int row=0; row< this.rows; row++){
			for(int col=0; col< this.columns; col++){
				System.out.print((this.board[row][col]==null)?Constants.DASH + Constants.SPACE:this.board[row][col] + Constants.SPACE);
			}
			System.out.println();
		}
	...
	public String toString(){
		...
		for(int row=0; row< this.rows; row++){
			for(int col=0; col< this.columns; col++){
				result +=  (this.board[row][col]==null)?Constants.DASH + Constants.SPACE:this.board[row][col] + Constants.SPACE;
			}
